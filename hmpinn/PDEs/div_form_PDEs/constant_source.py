"""
Constant Source PDE in Divergence Form.

This module provides a PDE implementation with constant source term,
featuring a quadratic analytical solution and Dirichlet boundary conditions.

Classes:
    ConstantSourceDF: PDE with constant source term in divergence form.
"""
...
class ConstantSourceDF(DivFormResidual, DirichletBC, WithSolution):
    """
    PDE with constant source term in divergence form.
    
    This class implements a Poisson equation with constant source term,
    ...
    def __init__(self, const_value=4.0, backend=torch):
        """
        Initialize the constant source PDE.
    ...
    def __repr__(self):
        """
        String representation of the ConstantSourceDF class.
        ...
        return f"ConstantSourceDF(const_value={self.const_value}, backend={backend_str})"